      ...
      if self.bellSoundPlayer == nil {
        ...
        if let soundURL = self.bellURL {
          do {
            ...
            self.bellSoundPlayer = try AVAudioPlayer(contentsOf: url)
...
//
//    do{
//      bellSoundPlayer = try AVAudioPlayer(contentsOf: url)
//      guard let player = bellSoundPlayer else {return}
